    ...
    <footer className={className + " " + footerclassName()}>
      <div className="site-footer px-6 bg-white dark:bg-slate-800 text-slate-500 dark:text-slate-300 py-4">
        <div className="grid md:grid-cols-2 grid-cols-1 md:gap-5">
          ...
          Swadeshi Mela Website - © 2023 Designed & Developed by <a  href="https://obifyconsulting.com/"
              rel="noreferrer"
              target="_blank"> Obify Consulting</a>
          </div>
          <div className="ltr:md:text-right hidden rtl:md:text-end text-center text-sm">
